...
<body class="bg-neutral-900">
    ...
    {{-- templates --}}
    <div class="bg-neutral-800 h-full w-screen flex flex-col overflow-x-hidden items-center" id="template">
        ...
        <div class="flex-1 flex gap-10 justify-center items-center h-full w-full select-none pb-10" >
            <div class="swiper mySwiper ">
                <div class="swiper-wrapper flex gap-10">
                <div class="swiper-slide min-w-[300px]">
                    <div class="flex flex-col w-96 min-w-[250px] h-[500px] bg-neutral-900 p-5 rounded-lg" data-aos="fade-up"data-aos-anchor-placement="center-bottom">
    ...
    {{-- Abouts --}}
    <div class="bg-neutral-900 h-full w-full flex flex-col items-center md:p-10 " id="about">
        <div class="pt-10 text-center" data-aos="fade-up"data-aos-anchor-placement="center-bottom">
    ...
    {{-- choose Us --}}
    <div class="bg-neutral-900  h-full w-full pb-20 flex flex-col lg:mt-0 mt-10 items-center md:p-10">
    ...
    {{-- contact Us --}}
    <div class="bg-neutral-800 h-full w-full pb-20 flex flex-col lg:mt-0 mt-10 items-center md:p-10" id="contact">
    ...
    <div class="bg-neutral-900 h-64 w-full  flex flex-col gap-20 lg:flex-row  justify-around lg:mt-0 mt-10 items-center md:p-10">
        ...
        <div class="text-white"  data-aos="fade-up"data-aos-anchor-placement="center-bottom">
            <div class="flex justify-center items-center flex-col">
                ...
                <ul class="flex">
                    <li class="px-5  hover:text-emerald-300 border-r-2 border-neutral-200 md:text-sm text-xs"><a href="#home">Home</a></li>
                    <li class="px-5  hover:text-emerald-300 border-r-2 border-neutral-200 md:text-sm text-xs"><a href="#template">Template</a></li>
                    <li class="px-5  hover:text-emerald-300 border-r-2 border-neutral-200 md:text-sm text-xs"><a href="#about">About</a></li>
                    <li class="px-5  md:text-sm text-xs"><a href="contact">Contact</a></li>
                </ul>
            </div>
            <p class="mt-4 text-center  md:text-sm text-xs"><i class='bx bx-copyright' style='color:#ffffff' ></i>Coyrights are belong to <span class="text-emerald-300">Aplinix</span></p>
        </div>
        <div class="text-white">
            <div class="flex flex-col" data-aos="fade-left"data-aos-anchor-placement="center-bottom" data-aos-duration="1500">
                <ul class="flex lg:flex-col flex-row">
                    <li class="px-5 hover:text-emerald-300 md:text-sm text-xs"><a href="">Privacy and policy</a></li>
                    <li class="px-5 hover:text-emerald-300 md:text-sm text-xs"><a href="">Terms and conditions</a></li>
                </ul>
            </div>
        </div>
    </div>
